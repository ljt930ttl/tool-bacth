...
// QueryRows 查询所有
func (b *BaseDB) QueryRows(sqlStr string, args ...interface{}) ([]MapSS, error) {
	rows, err := b.Query(sqlStr, args...)
	if err != nil {
		logger.Error("err:%s\nsql:%s\n", err.Error(), sqlStr)
		return nil, err
	}
...
func (b *BaseDB) ExecControl(sqlStr string, args ...interface{}) error {
